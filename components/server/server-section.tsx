    ...
    <div className='flex items-center justify-between py-2'>
        ...
        {role==="ADMIN" && sectionType==='channels' &&(
            <ActionTooltip label='Create channel' side='top'>
                <button onClick={()=>openModal('channel',{server,channelType})} className='text-zinc-500 hover:text-zinc-600  dark:text-zinc-400 dark:hover:text-zinc-300 transition'>
