  ...
  return (
    <div>
        ...
        <button type='button' className='group' onClick={()=>openModal('createServer')}>
            <div className='w-[38px] h-[38px] rounded-[24px] flex items-center justify-center bg-white dark:bg-neutral-700 group-hover:rounded-[16px] duration-150 group-hover:bg-emerald-500'>
